...
if __name__ == '__main__':
    ...
    with pyvirtualdisplay.Display(visible=False, size=(1920, 1080)) as disp:
        ...
        base_path = f'/lustre/mlnvme/data/s94zalek_hpc-shape_matching/figures/p2p_baseline/{dataset_name}'
        ...
        # for k in tqdm(range(len(idxs_geo_err))):
            ...
            p2p_ulrssm = torch.load(f'/home/s94zalek_hpc/baselines/Unsupervised-Learning-of-Robust-Spectral-Shape-Matching/results/dt4d_intra_class/visualization/{indx}.pth')
