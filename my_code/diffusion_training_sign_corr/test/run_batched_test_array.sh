experiment_names=(
    ...
    # 'single_128_1-1-2-2ev_64-128-128_remeshed_bbox'
    # 'single_128_1-2-2-2ev_64-128-128_remeshed_bbox'
    # 'single_128_1-2-2-4ev_128-256-256_remeshed'


    # 'single_64_SMAL_nocat_64_SMAL_isoRemesh_0.2_0.8_nocat_1-2ev_32k'
    # 'single_64_SMAL_nocat_64_SMAL_isoRemesh_0.2_0.8_nocat_1-2ev_64k'
)
checkpoint_names=(
    # 'checkpoint_99.pt'
    # 'checkpoint_99.pt'
